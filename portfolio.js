...
let p7 = new Project(
  ...
  "A twitter sentiment analysis on the 2019 Election using the Naive Bayes Classification model. Tweets about the election were extracted and their sentiments were assessed and defined, and the polarity of these tweets were then used to predict the results against real time results. <br><i>(Img credit: https://uc-r.github.io/public/images/analytics/naive_bayes/naive_bayes_icon.png)</i>",
