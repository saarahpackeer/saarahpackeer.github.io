...
<template>
  <section class="max-w-4xl mx-auto px-4 sm:px-6 py-16 w-full relative z-10">
    <div class="mb-12 fu-1">
      ...
      <p class="opacity-60 text-lg">Get to know me a little better</p>
    </div>

    <div class="grid md:grid-cols-2 gap-10 fu-2">

      <div>
        <p class="text-base sm:text-lg leading-relaxed opacity-80 mb-8" style="line-height:1.8;">
          {{ profile.aboutBio }}
        </p>

        <div class="space-y-4">
          <p class="text-sm font-semibold opacity-60 uppercase tracking-wide">Things I Love</p>
          <div class="space-y-3">
            <div
      ...
      <!--
        PHOTOS
        Add image files to public/photos/ and list their filenames
        in src/data/profile.ts under the "photos" array.
        Missing images hide gracefully; the gradient tile stays visible.
      -->
